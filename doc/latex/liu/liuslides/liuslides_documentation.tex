...
{
\begin{itemize}
\item \colorbox{LiUblue}{\color{white}blue}, \colorbox{LiUblue3}{\color{black}lightblue} and \colorbox{LiUblue5}{\color{black}brightblue}
\item \colorbox{LiUgreen}{\color{white}green}, \colorbox{LiUgreen3}{\color{black}lightgreen} and \colorbox{LiUgreen5}{\color{black}brightgreen}
\item \colorbox{LiUturquoise}{\color{white}turquoise}, \colorbox{LiUturquoise3}{\color{black}lightturquoise} and \colorbox{LiUturquoise5}{\color{black}brightturquoise}
\end{itemize}
}
